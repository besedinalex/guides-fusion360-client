        ...
        return (
            <div>
                <form className="form-auth">
                    ...
                    <input onChange={this.handleInviteCodeChange} type="text" className="form-control form-control-mid" placeholder="Код приглашения" />
                    <input onChange={this.handleFirstNameChange} type="text" className="form-control form-control-mid" placeholder="Имя" />
                    <input onChange={this.handleLastNameChange} type="text" className="form-control form-control-mid" placeholder="Фамилия" />
                    <input onChange={this.handleGroupChange} type="text" className="form-control form-control-mid" placeholder="Группа" />
